    ...
    */
    ...
    wsEvent(packet) {
        switch(packet.t) { /* eslint-disable no-redeclare */ // (╯°□°）╯︵ ┻━┻
            ...
            case "MESSAGE_CREATE": {
                const channel = {id: packet.d.channel_id};
                if(channel) { // MESSAGE_CREATE just when deleting o.o
                    ...
                    */
                    this.emit("messageCreate", {channel, ...packet.d});
                } else {
                ...
                if(!packet.d.unavailable) {
                    ...
                    if(this.ready) {
                        if(this.client.unavailableGuilds.remove(packet.d)) {
                            ...
                            * @prop {Guild} guild The guild
                            */
                            this.emit("rawGuildCreate", packet.d);
    ...
    createGuild(_guild) {
        ...
        const guild = this.client.guilds.add({id: _guild.id, channels: _guild.channels}, this.client, true);
